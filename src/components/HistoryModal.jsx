...
export default function HistoryModal({ stationId, stationName, onClose }) {
  ...
  useEffect(() => {
    ...
    setRows(null);
    setError(null);
    fetchNodeHistory(stationId, rangeHours)
      .then((data) => {
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal__controls">
          ...
          <div className="layer-controls__segmented modal__range">
            {RANGES.map((r) => (
              <button
                key={r.label}
                type="button"
        ...
        {error ? (
          <div className="modal__error">Couldn't load history: {error}</div>
        ) : rows === null ? (
        ...
        <a
          ...
          href={`https://meter.ac/gs/nodes/${stationId}/history.html`}
          target="_blank"
          rel="noreferrer"
        >
